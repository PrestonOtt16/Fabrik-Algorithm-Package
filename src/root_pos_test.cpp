...
int main()
{
	...
	vector<joint> jl_ = a1.root_arm(a1.jlist,a1.llist);
	
	ostream &r = cout;
	r << "The joint positions p1,p2,p3,p4,p5 after the root_arm() function are: " << endl;
	for(auto it = jl_.begin(); it != jl_.end(); it++)
	{
		it->jpos.print(r,it->jpos);
		r << endl;
	}
